        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="w-full md:w-2/5 border rounded p-6 flex flex-col items-center">
            ...
            <div className="mt-8 space-y-3 text-sm w-full">
              ...
              {/* Rating */}
              <div className="text-lg flex items-center gap-2 text-gray-500 pl-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-indigo-600 hover:bg-indigo-700 text-white rounded px-4 py-2 text-lg font-bold"
              >
                Send Message
              </button>
            </form>
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <select className="border border-gray-300 rounded px-4 py-2 text-lg w-full md:w-auto">
