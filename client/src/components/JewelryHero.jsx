...
const JewelryHero = () => {
  ...
  const categories = ["Necklace", "Rings", "Bracelet", "earring", "Antique Jewelry", "Anklet", "Statement Jewelry", "Diamond Rings"];
  ...
  return (
    <div className="px-45 py-8 bg-[#f4f4f4]">
      <div className="text-sm text-gray-500 mb-4 space-x-2">
        ...
        <span>&gt;</span>
        <span className="text-black font-medium">Jewelry & Accessories</span>
      </div>
      ...
      <div className="flex">
        ...
        <aside className="w-[290px] bg-white p-4 rounded-lg shadow-sm mr-6">
          ...
          <div className="mb-6">
            ...
            {["0 - 50000.00 BDT", "50000.00 - 100000.00 BDT", "100000.00 BDT +"].map((option, i) => (
