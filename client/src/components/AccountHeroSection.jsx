...
const AccountHeroSection = () => {
  return (
    <section className="py-12 px-4 md:px-28 bg-[#f4f4f4]"> {/* Adjusted padding to match nav */}
      <h1 className="text-3xl font-bold text-center mb-10">My account</h1>

      <div className="px-20 grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-8"> {/* Adjust column ratio */}
        
        {/* Sidebar */}
        <div className="box-border h-102 w-100 border-1 border-gray-300 rounded-md p-6 bg-white ">
        <div className=" flex items-center border-b pb-5 mb-5">
          <img
            src={img}
            alt="User"
            className="rounded-full w-28 h-30"
          />
          ...
          <div className="flex flex-col space-y-4 text-sm px-4 ml-5">
            ...
            <a href="#" className="hover:underline">Account Details</a>
            <a href="#" className="hover:underline text-red-600 font-medium">Log out</a>
          </div>
        </div>
        ...
        <div className="border border-gray-300 rounded-md p-6 bg-gray-100">
          ...
          <div className="box-border h-30 w-150 border-1 mt-20 ml-25 rounded p-4 bg-white"> {/* Added top margin */}
            <a href="#" className="font-semibold underline block mb-1 mt-3">Become a Vendor</a>
