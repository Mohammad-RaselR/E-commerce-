...
const BeautyHero = () => {
  ...
  const categories = ["Makeup", "Skin", "Hair", "Personal Care", "Fragrance"];
  ...
  return (
    <div className="px-45 py-8 bg-[#f4f4f4]">
      <div className="text-sm text-gray-500 mb-4 space-x-2">
        ...
        <span>&gt;</span>
        <span className="text-black font-medium">Beauty & Health</span>
      </div>
      ...
      <div className="flex">
        ...
        <aside className="w-[290px] bg-white p-4 rounded-lg shadow-sm mr-6">
          ...
          <div className="mb-6">
            ...
            {["0 - 1500.00 BDT", "500.00 - 3000.00 BDT", "3000.00 BDT +"].map((option, i) => (
