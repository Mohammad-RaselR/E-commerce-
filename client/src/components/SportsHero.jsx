...
const SportsHero = () => {
  ...
  const categories = ["Athletics", "Cricket", "Football", "Basketball", "Boxing", "Golf", "Table Tennis", "Volleyball"];
  ...
  const allBrands = ["Nike", "Puma", "Adidas", "Reebok", "New Balance"];
  ...
  return (
    <div className="px-45 py-8 bg-[#f4f4f4]">
      <div className="text-sm text-gray-500 mb-4 space-x-2">
        ...
        <span>&gt;</span>
        <span className="text-black font-medium">Sports & Entertainment</span>
      </div>
