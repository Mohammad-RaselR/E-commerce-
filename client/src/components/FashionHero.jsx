...
const FashionHero = () => {
  ...
  const categories = ["Kids", "Man", "Woman"];
  ...
  const allBrands = ["Gentle Park", "Sailor", "Aarong", "Yellow", "Richman", "Ecstasy"];
      ...
      <div className="flex">
        ...
        <aside className="w-[290px] bg-white p-4 rounded-lg shadow-sm mr-6">
          ...
          <div className="mb-6">
            ...
            {["0 - 1000.00 BDT", "1000.00 - 3000.00 BDT", "3000.00 BDT +"].map((option, i) => (
